...
sys.path.append(os.path.dirname(os.path.abspath(__file__)) + "Recurrent_Neural_Networks")
...
class CRDQN():
    def __init__(self, x_dim, n_outputs, hidden_layer_sizes, gamma,
        ...
        #########################################
        RNN_Block_Layer = RNNBlocks.RNNBlock(FC_INPUT_SIZE, FC_INPUT_SIZE, 500 , 1)
        self.RNN_Layers.append(RNN_Block_Layer)
