# -*- coding: utf-8 -*-
"""
Created on Sun Aug 26 17:53:06 2018
...
class ManualCarUnrealEnvironment:
    ...
    # input mode defines the controller (xbox or keyboard listener)
    # simmode describes what the environment will return ( ie: states, images, or both)
